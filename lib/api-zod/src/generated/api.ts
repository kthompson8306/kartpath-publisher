...
export const ListPublishedContentItemsQueryParams = zod.object({
  "contentType": zod.enum(['featured-family', 'nonprofit-spotlight', 'young-achiever', 'people-around-town', 'pet-of-the-month', 'business-listing', 'event', 'crooks-corner', 'recipe', 'lifestyle-column', 'digital_edition']).optional(),
...
export const ListPublishedContentItemsResponseItem = zod.object({
  ...
  "contentType": zod.enum(['featured-family', 'nonprofit-spotlight', 'young-achiever', 'people-around-town', 'pet-of-the-month', 'business-listing', 'event', 'crooks-corner', 'recipe', 'lifestyle-column', 'digital_edition']),
