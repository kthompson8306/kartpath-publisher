...
export const ListPublishedContentItemsQueryParams = zod.object({
  "contentType": zod.enum(['featured-family', 'nonprofit-spotlight', 'young-achiever', 'people-around-town', 'pet-of-the-month', 'business-listing', 'event', 'crooks-corner', 'recipe', 'lifestyle-column', 'digital_edition', 'about-page']).optional(),
...
export const ListPublishedContentItemsResponseItem = zod.object({
  ...
  "contentType": zod.enum(['featured-family', 'nonprofit-spotlight', 'young-achiever', 'people-around-town', 'pet-of-the-month', 'business-listing', 'event', 'crooks-corner', 'recipe', 'lifestyle-column', 'digital_edition', 'about-page']),
  ...
  "listingTier": zod.string().optional(),
  "businessDescription": zod.string().nullable().optional(),
...
export const CreateContentItemBody = zod.object({
  ...
  "body": zod.string(),
  "pullQuote": zod.string().nullable().optional(),
  "metaDescription": zod.string().max(160).nullable().optional(),
  "listingTier": zod.string().optional(),
  "businessDescription": zod.string().nullable().optional(),
  "details": zod.record(zod.string(), zod.string()),
  "coverMediaId": zod.string().nullable(),
